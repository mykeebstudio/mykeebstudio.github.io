...
export const RMK_JPKEYS: readonly RmkJpKeyChoice[] = [
  ...
  { id: 'JP_LBRACELBRACKET', label: '[ / {', description: 'JP_LBRACELBRACKET (legacy token; actual output [ / {)', action: () => makeHidKeyAction('F19') },
  { id: 'JP_RBRACERBRACKET', label: '] / }', description: 'JP_RBRACERBRACKET (legacy token; actual output ] / })', action: () => makeHidKeyAction('F20') },
  ...
  { id: 'JP_LBRACE', label: '{', description: 'JP_LBRACE', action: () => shifted('RightBracket') },
  { id: 'JP_LBRACKET', label: '[', description: 'JP_LBRACKET', action: () => makeHidKeyAction('RightBracket') },
  { id: 'JP_RBRACE', label: '}', description: 'JP_RBRACE', action: () => shifted('Backslash') },
  { id: 'JP_RBRACKET', label: ']', description: 'JP_RBRACKET', action: () => makeHidKeyAction('Backslash') },
