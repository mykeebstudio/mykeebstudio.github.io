export type RmkKeyDisplay = {
  primary: string;
  secondary: string;
};

const SIMPLE: Record<string, RmkKeyDisplay> = {
...
export function rmkFriendlyKeyDisplay(name: string): RmkKeyDisplay {
...
export function rmkFriendlyModifierName(name: string) {
  const display = rmkFriendlyKeyDisplay(name);
